...
# Create a custom user manager because we don't want the username for login
...
class User(AbstractBaseUser):
    ...
    # Use the user manager instead of the default one
...
class UserProfile(models.Model):
    # Each user needs to have a UserProfile
    # We separate to give here more information about the user
